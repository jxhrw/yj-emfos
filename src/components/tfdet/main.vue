    ...
    <div class="ej-main">
        ...
        <div class="ej-content">
                    ...
                    <el-row class="content-row-select">
                        <el-col :span="12">
                            <div class="content-base content-left">
                                ...
                                <ul class="base-info">
                                    <li><span>编码</span><span>{{baseInfo.devId}}</span></li>
                                    <li><span>名称</span><span>{{baseInfo.devName}}</span></li>
                                    <li><span>类型</span><span>{{baseInfo.devTypeName}}</span></li>
                                    <li><span>辖区</span><span>{{baseInfo.devAreaName}}</span></li>
                                    <li><span>设备状态</span>
                        ...
                        <el-col :span="12">
                            <div class="content-base content-right">
                                ...
                                <div class="base-portrait" :class="'base-type-'+baseInfo.devTypeCode">
            ...
            <el-dialog title="关联视频" :visible.sync="relationVisible" width='730px' class="dialog-urge" :modal="false">
                <EJ-DialogVideo :devTypeCode="baseInfo.devTypeCode" :devId="baseInfo.devId" :myVideoList="videoList" ref="dialogVideo"></EJ-DialogVideo>
            </el-dialog>
            <EJ-DialogVideo :devTypeCode="baseInfo.devTypeCode" :devId="baseInfo.devId" ref="dialogVideoTest" style="display:none;"></EJ-DialogVideo>
...
<script>
    ...
    import Information from "components/tfdet/information";
    import Repair from "components/tfdet/repair";
    import Patrol from "components/tfdet/patrol";
    import Report from "components/tfdet/report";
        ...
        methods: {
            ...
            initMap() {
                ...
                _map.addEventListener(EJMap.Event.onLayerAdded, function(e) {
                    ...
                    //     _map.setLayerVisibleById(_layer, false);
                    // }
                    _this.getPoint(_this.baseInfo.longitude, _this.baseInfo.latitude, false, true, true);
                });
                this.isHaveMap = true;
            },
            // 地图定位相关--end
            operateFuc(type) {
                ...
                switch (type) {
                    case 'add':
                        url = this.$config.ProjectName + "/tfedit.html?token=" + this.token;
            ...
            goEditOnlyRead() {
                let url = this.$config.ProjectName + "/tfedit.html?token=" + this.token + "&devId=" + this.baseInfo.devId + "&devTypeCode=" + this.baseInfo.devTypeCode + "&type=onlyread";
                // sessionStorage.setItem('indexIframe', url);
                window.location.href = url;
            },
            goBack() {
...
<style scoped>
    ...
    .ej-content-title .btn-operation {
        background: #00c1ba;
        border: 1px solid #00c1ba;
        color: #ffffff;
    }

    .ej-content-title .btn-back {
        background: rgba(255, 255, 255, 0.09);
        border: 1px solid #4F5A64;
        color: #4F5A64;
    }

    .ej-content-title .btn-title:hover {
        opacity: 0.5;
    }

    .ej-content-title .btn-title:active {
        opacity: 0.9;
    }

    .ej-main>>>.el-dialog__title {
        font-size: 14px;
        overflow: hidden;
    ...
    .dialog-urge .dialog-main .rotation {
    ...
    .dialog-urge .dialog-main .rotation>>>.el-carousel__item {
        background-color: #99a9bf;
    }

    .dialog-urge .dialog-main .rotation>>>.el-carousel__button {
        width: 8px;
        height: 8px;
        border-radius: 4px;
    }

    .dialog-urge .dialog-main .carousel-image {
        height: 100%;
        background: no-repeat center/contain;
    }

    .dialog-urge .dialog-main .ej-load-scrollbar {
        height: 100px;
        overflow-x: hidden;
    }

    .dialog-urge .dialog-main .ej-load-scrollbar>>>.el-scrollbar__wrap {
        overflow-x: hidden;
    }

    .dialog-urge .dialog-main .file-download li {
        display: flex;
        font-size: 12px;
        margin-top: 12px;
        /*line-height: 12px;*/
    ...
    .dialog-urge .dialog-main .file-download li:first-child {
        margin: 0;
    }

    .dialog-urge .dialog-main .file-download li a {
        font-size: 12px;
        color: #6BA1EB;
        text-decoration: underline;
    }

    .dialog-urge .dialog-main .file-download li a.load-fileName {
        width: 250px;
        overflow: hidden;
        text-overflow: ellipsis;
        white-space: nowrap;
    ...
    .dialog-urge .dialog-main .file-download li a.load-hoverShow {
        margin-left: 20px;
        display: none;
        cursor: pointer;
    }

    .dialog-urge .dialog-main .file-download li:hover a.load-hoverShow {
        display: block;
    }
