    ...
    <div class="depiction-info">
        ...
        <div class="content">
            <el-table highlight-current-row :data="tableData" stripe border class="content-table" @current-change='currentSelect' v-loading="isTableLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.7)">
                ...
                <el-table-column fixed label="设施编号" prop="facilityId" show-overflow-tooltip></el-table-column>
                <el-table-column fixed label="设施名称" prop="facilityName" show-overflow-tooltip min-width="140"></el-table-column>
                <el-table-column label="设施子类型" prop="signsCodeName" show-overflow-tooltip></el-table-column>
                <el-table-column label="所属道路" prop="roadName" show-overflow-tooltip></el-table-column>
                <el-table-column label="所属辖区" prop="regionName" show-overflow-tooltip></el-table-column>
                <el-table-column label="建设日期" prop="buildDate" show-overflow-tooltip></el-table-column>
                <el-table-column label="维护单位" prop="oppmDeptName" show-overflow-tooltip></el-table-column>
                <el-table-column label="设施状态" prop="devStatusName" show-overflow-tooltip></el-table-column>
...
<script>
    ...
    export default {
        components: {
            ...
            "EJ-DialogPassing": DialogPassing
        },
        data() {
            return {
                title: "查询结果",
        ...
        methods: {
            ...
            operateFuc(type) {
                ...
                switch (type) {
                    case 'add':
                        url = this.$config.ProjectName + "/tffacedit.html?token=" + this.token + "&facilityTypeCode=" + this.queryConditions.facilityTypeCode;
            ...
            gotoDetail(obj) {
                let url = this.$config.ProjectName + "/tffacdet.html?token=" + this.token;
                // sessionStorage.setItem('indexIframe', url);
                sessionStorage.setItem('tffacDetailInfo', JSON.stringify(obj));
                window.location.href = url;
            },
            currentSelect(e) {
                this.currentIndex = 0;
