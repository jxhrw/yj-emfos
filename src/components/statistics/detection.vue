                    ...
                    <div class="depiction-info">
                        ...
                        <div class="content">
                            <el-table :highlight-current-row="false" :data="tableData" stripe border class="content-table" @current-change='currentSelect' v-loading="isTableLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.7)">
                                ...
                                <el-table-column prop="NAME" :label="headTypeNameNow" show-overflow-tooltip min-width="120"></el-table-column>
                                <el-table-column prop="TYPE" label="设备类型" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="DEVICESUM" label="设备数量" show-overflow-tooltip min-width="120"></el-table-column>
                                <el-table-column prop="QY" label="启用" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="TY" label="停用" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="ZC" label="正常" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="GZ" label="异常" show-overflow-tooltip></el-table-column>
                                <!-- <el-table-column prop="GZL" label="故障率" show-overflow-tooltip>
                                    <template slot-scope="scope">
                                        <p>{{scope.row.GZL}}%</p>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="BX" label="报修" show-overflow-tooltip></el-table-column> -->
                            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            searchTable() {
                ...
                this.$api.get(`${this.$config.efoms_HOST}/efoms-rest/CheckReport/getDeviceStatusTJ`, this.queryConditions, null).then((res) => {
            ...
            exportExcel() {
                ...
                let method = '/efoms-rest/export/exportDeviceStatusTJ';
