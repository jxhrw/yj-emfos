                    ...
                    <div class="depiction-info">
                        ...
                        <div class="content">
                            <el-table :highlight-current-row="false" :data="tableData" stripe border class="content-table" @current-change='currentSelect' v-loading="isTableLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.7)">
                                ...
                                <el-table-column prop="XHJ" label="信号机" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="XHJK" label="视频监控" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="KK" label="卡口" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="DJ" label="电警" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="DC" label="地磁" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="XQ" label="线圈" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="WB" label="微波" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="YD" label="诱导屏" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="SPJC" label="视频检测" show-overflow-tooltip></el-table-column>
                            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            searchTable() {
                ...
                this.$api.get(`${this.$config.efoms_HOST}/efoms-rest/CheckReport/getDevsumForOther`, this.queryConditions, null).then((res) => {
            ...
            exportExcel() {
                ...
                let method = '/efoms-rest/NewExport/exportDeviceStatusOther';
