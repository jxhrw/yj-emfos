                    ...
                    <div class="depiction-info">
                        ...
                        <div class="content">
                            <el-table :highlight-current-row="false" :data="tableData" stripe border class="content-table" @current-change='currentSelect' v-loading="isTableLoading" element-loading-text="拼命加载中" element-loading-spinner="el-icon-loading" element-loading-background="rgba(255, 255, 255, 0.7)">
                                ...
                                <el-table-column prop="DEVICESUM" label="设备总数" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="PZC" label="网络正常" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="PGZ" label="网络故障" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="PWZ" label="网络未知" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="DZC" label="数据正常" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="DGZ" label="数据异常" show-overflow-tooltip></el-table-column>
                                <el-table-column prop="DWZ" label="数据未知" show-overflow-tooltip></el-table-column>
                            </el-table>
    ...
    export default {
        ...
        methods: {
            ...
            searchTable() {
                ...
                this.$api.get(`${this.$config.efoms_HOST}/efoms-rest/CheckReport/getDevReportForSBZT`, this.queryConditions, null).then((res) => {
            ...
            exportExcel() {
                ...
                let method = '/efoms-rest/export/exportDeviceStatusSBZT';
