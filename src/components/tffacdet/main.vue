            ...
            <el-dialog title="图文附件" :visible.sync="annexVisible" width='400px' :modal="false">
                <div class="dialog-urge">
                            ...
                            <el-scrollbar class="ej-load-scrollbar">
                                <ul class="file-download">
                                    <li v-for="(item,index) in filesShowList" :key="index">
                                        ...
                                        <a class="load-hoverShow" :href="item" download="">下载</a>
                    ...
                    <div slot="footer" class="dialog-footer">
                        ...
                        <el-button @click="annexVisible=false" size='mini' class="cancel">关 闭</el-button>
                    </div>
                </div>
            </el-dialog>
    ...
    export default {
        ...
        methods: {
            ...
            getInfoInterface() {
                let method = "";
                let obj = {};
                let facilityId = this.baseInfo.facilityId;
                let signsType = this.baseInfo.signsType;
            ...
            saveBaseInfo() {
                ...
                let postData = this.getModifyInterface().object;
                this.changeDevFuc(method, postData, (res) => {
