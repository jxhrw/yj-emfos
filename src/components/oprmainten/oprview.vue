          ...
          <div class="base-info">
            <div class="base-attribute">
              ...
              <div class="content">
                ...
                <el-row class="content-row-select">
                  <el-col :span="12">
                    <label><span>单位类型</span></label>
                    <el-input v-model="deptType" placeholder="" size='mini' class="content-select" clearable :disabled="isReadonly"></el-input>
                  </el-col>
                  <el-col :span="12">
                    <label><span>上级部门</span></label>
                    <el-input v-model="topDept" placeholder="" size='mini' class="content-select" clearable :disabled="isReadonly"></el-input>
                  </el-col>
                </el-row>
                <el-row class="content-row-select">
                  <el-col :span="12">
