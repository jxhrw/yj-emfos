              ...
              <div class="content">
                <el-row class="content-row-select">
                  ...
                  <el-col :span="8">
                    ...
                    <el-input v-model="genderName" placeholder="" size='mini' class="content-select" clearable :disabled="isReadonly"></el-input>
                  </el-col>
                  <el-col :span="8">
                    <label><span>人员类型</span></label>
                    <el-input v-model="personTypeName" placeholder="" size='mini' class="content-select" clearable :disabled="isReadonly"></el-input>
                  </el-col>
                </el-row>
                <el-row class="content-row-select">
                  <el-col :span="8">
                  ...
                  <el-col :span="8">
                    ...
                    <el-input v-model="statusName" placeholder="" size='mini' class="content-select" clearable :disabled="isReadonly"></el-input>
                  </el-col>
                  <el-col :span="8">
                    <label><span>所属单位</span></label>
                    <el-input v-model="opsDeptName" placeholder="" size='mini' class="content-select" clearable :disabled="isReadonly"></el-input>
                  </el-col>
                </el-row>
                <el-row class="content-row-select">
                  <el-col :span="8">
